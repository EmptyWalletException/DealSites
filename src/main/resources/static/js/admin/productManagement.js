...
var currentPage;
$(function(){
    to_page("/admin/getProductList",1);
...
function checkStateChoose(pn){
    ...
    if ("shelveProduct" == checkedInput){
        to_page("/admin/getShelveProduct",pn);
    } else if ("unShelveProduct" == checkedInput){
        to_page("/admin/getUnShelveProduct",pn);
    } else {
        to_page("/admin/getProductList",pn);
    }
}
...
$("#shelveProduct").click(function () {
    to_page("/admin/getShelveProduct",1);
})

$("#unShelveProduct").click(function () {
    to_page("/admin/getUnShelveProduct",1);
})
